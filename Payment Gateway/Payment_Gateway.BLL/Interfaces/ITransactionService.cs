...
namespace Payment_Gateway.BLL.Interfaces
{
    public interface ITransactionService
    {
        ...
        Task<ServiceResponse<IEnumerable<TransactionHistory>>> GetUsersTransactionHistory();
        ...
        Task<ServiceResponse<IEnumerable<TransactionDto>>> GetTransaction(GetTransactionRequest request);
